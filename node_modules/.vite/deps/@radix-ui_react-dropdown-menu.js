...
var PopperAnchor = React24.forwardRef(
  (props, forwardedRef) => {
    ...
    return virtualRef ? null : (0, import_jsx_runtime16.jsx)(Primitive5.div, { ...anchorProps, ref: composedRefs });
  }
);
...
var Portal = React26.forwardRef((props, forwardedRef) => {
  ...
  return container ? import_react_dom2.default.createPortal((0, import_jsx_runtime18.jsx)(Primitive6.div, { ...portalProps, ref: forwardedRef }), container) : null;
});
