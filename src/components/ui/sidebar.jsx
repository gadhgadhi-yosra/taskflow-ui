  ...
  return (
    <button
      ...
      className={cn(
        ...
        "group-data-[side=left]:-right-4 group-data-[side=right]:left-0 hover:after:bg-sidebar-border sm:flex",
...
export const SidebarGroupAction = React.forwardRef(({ className, asChild = false, showOnHover = false, ...props }, ref) => {
  ...
  return (
    <Comp
      ...
      className={cn(
        ...
        "outline-none ring-sidebar-ring transition-transform hover:bg-sidebar-accent hover:text-sidebar-accent-foreground focus-visible:ring-2",
        "after:absolute after:-inset-2 after:md:hidden group-data-[collapsible=icon]:hidden [&>svg]:size-4 [&>svg]:shrink-0",
        showOnHover &&
  ...
  return (
    <Comp
      ...
      className={cn(
        ...
        "aria-disabled:pointer-events-none aria-disabled:opacity-50 hover:bg-sidebar-accent hover:text-sidebar-accent-foreground focus-visible:ring-2",
