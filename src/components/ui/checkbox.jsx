...
${colorConfig
  .map(([key, itemConfig]) => {
    const clr = itemConfig.theme?.[theme] || itemConfig.color;
    return clr ? `  --color-${key}: ${clr};` : null;
  })
  .filter(Boolean)
  .join("\n")}
}
...
function getPayloadConfigFromPayload(config, payload, key) {
  ...
  else if (payloadPayload && typeof payloadPayload[key] === "string") cfgKey = payloadPayload[key];
                ...
                {formatter && item?.value !== undefined && item.name ? (
                  ...
                  <>
                    {!itemCfg?.icon && !hideIndicator ? (
                      ...
                      />
                    ) : itemCfg?.icon ? <itemCfg.icon /> : null}
